...
export const Route = createFileRoute("/investments")({
  head: () => ({
    meta: [
      { title: "Investimentos — Vamo Dale!!" },
      { name: "description", content: "Acompanhe seus investimentos e sua meta de patrimônio de R$ 50 mil." },
    ],
  }),
...
function InvestmentsPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f8fb] text-slate-950">
      <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-4 lg:px-8">
          <div className="flex items-center gap-3">
            ...
            <div><p className="text-sm font-medium text-slate-500">Vamo Dale!!</p><h1 className="font-bold">Meus investimentos</h1></div>
          </div>
      ...
      <div className="mx-auto max-w-7xl px-5 py-7 lg:px-8"><InvestmentsDashboard userId={userId} /></div>
    </main>
  );
}
